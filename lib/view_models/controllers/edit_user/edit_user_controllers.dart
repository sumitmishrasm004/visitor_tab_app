...
import 'package:visitor_app/repository/edit_user/edit_user_repository.dart';
...
class EditUserModel extends GetxController {
  ...
  void updateVisitor() {
    ...
    _api.updateVisitor(data).then((value) {
      loading.value = false;
